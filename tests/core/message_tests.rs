...
use iflow_cli_sdk_rust::config::options::ErrorMessageDetails;
use iflow_cli_sdk_rust::message::types::{
    Icon, Message, PlanEntry, PlanPriority, PlanStatus, ToolCallMessage,
...
async fn test_tool_call_message_comprehensive() {
    ...
    let tool_call = ToolCallMessage::new(
        ...
        icon.clone(),
        iflow_cli_sdk_rust::message::types::ToolCallStatus::Running,
    );
